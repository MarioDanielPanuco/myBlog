...
> but the approximate present does not approximately determine the future. <cite>Edward Lorenz</cite>
...
My work sits at the intersection of **scientific machine learning, numerical methods, and high-performance scientific computing**. I’m especially interested in neural operators and other learned representations of dynamical systems: how to build fast surrogate models for PDEs, evaluate them beyond short-term trajectory prediction, and use them for inverse problems, uncertainty-aware inference, and control.

More broadly, I’m interested in computational methods that remain useful when systems are chaotic, partially observed, expensive to simulate, or difficult to model across multiple spatial and temporal scales.
